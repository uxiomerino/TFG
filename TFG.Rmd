...
```{r}
vif(axuste_victorias11)
```

```{r}
axuste_victorias13 <- glm(Resultado~.-Xornada-Asist-`%TL`-FRea-PPT3-TL_Min-TRea-T2Asist-PPT2-PPPos-T3Asist-RebTot, data = df_equipos, family = binomial)
anova(axuste_victorias11, axuste_victorias13, test = "Chisq")
```

```{r}
summary(axuste_victorias13)

vif(axuste_victorias13)
```

```{r}
axuste_victorias_final <- axuste_victorias13
