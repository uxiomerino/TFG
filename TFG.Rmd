...
buscar_xogador(df_con_cluster, "20 NICO LAPROVITTOLA", año = "2023/24", cluster =  2)
```

```{r}
# Exemplo de uso da funcion busqueda_xogadores_cercanos
busqueda_xogadores_cercanos(df_con_cluster, "20 NICO LAPROVITTOLA", distancia = 3)[1]
busqueda_xogadores_cercanos(df_con_cluster, "20 NICO LAPROVITTOLA", distancia = 3, cluster = 6)[1]
```
...
```{r}
hist(df_quintetos$Dif, prob = T, breaks = "FD")
lines(density(df_quintetos$Dif), col = "blue", lwd = 2)
print(length(boxplot(df_quintetos$Dif, outline = TRUE, main ="Boxplot de Dif")$out))
print(shapiro.test(df_quintetos$Dif)$p.value)
```
