...
modelo_rf <- randomForest(Media ~ .-Minutos, data = train_quintetos)
...
errores_absolutos <- abs(predicions - test_quintetos$Media)

# Calcular el error cuadrático medio
mae <- mean(errores_absolutos)
...
modelo_rf <- train(Media ~ ., data = train_obra, method = "rf", trControl = trainControl(method = "cv", number = 15))
modelo_rf
```
