...
```{r}
df_suma <- aggregate(Minutos ~ C1+C2+C3+C4+C5+C6, data = quintetosRebTot_obra, FUN = sum)
df_suma <- df_suma[order(df_suma$Minutos, decreasing = TRUE), ]
head(df_suma)
nrow(df_suma)
```
