...
```{r}
range(quintetos_obra_limpos$Diferencia)
randomForestObra$results$MAE[randomForestObra$bestTune$mtry] / sd(quintetos_obra_limpos$Diferencia)
```
...
non_expl_max$Predicion <- max(predsObra3)
...
abline(v = max(predsObra3), col = "red", lwd = 2)
```
