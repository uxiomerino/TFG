...
```{r}
victoriasObra <- lm(formula = Resultado ~ PPT2 + PPT3 + TAsist + T2Asist + 
    TL_Min + TL_F + RebTot + `%TL` + Asist + TO + Rec + TRea + 
    FRea, data = partidosObra)
...
```{r}
victoriasObra <- lm(formula = Resultado ~ PPT2 + PPT3 + TAsist + 
...
```{r}
victoriasObra <- lm(formula = Resultado ~ PPT3 + 
    TL_Min + RebTot + TO + Rec + 
    FRea, data = partidosObra)
