...
plot(axuste_interaccions)
plot(axuste_interaccions$residuals)
t.test(axuste_interaccions$residuals, mu = 0)
Box.test(axuste_interaccions$residuals)
shapiro.test(axuste_interaccions$residuals)
vif(axuste_interaccions)
```
