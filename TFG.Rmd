...
quintetos$Ano <- rep("2023/24", length(quintetos$Equipo))
...
df_combinaciones[which.min(df_combinaciones$Diferencia), ]
```

```{r}
df_combinaciones <- df_combinaciones[df_combinaciones$Minutos >= 0.35, ]
```
