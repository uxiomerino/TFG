...
```{r}
clusters <- hkmeans(df_clusters, k = 5)
...
```{r}
ordered_clustered_data[ordered_clustered_data$CLUSTER==5,]
```
...
```{r}
clusters_jerarquico <- cutree(clustering_jerarquico, h = 12)
...
```{r}
ordered_clustered_jerarquico[ordered_clustered_jerarquico$CLUSTER==2, ]
```