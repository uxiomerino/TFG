...
```{r}
axuste_victorias_final <- lm(Resultado ~ PPT + RebTot + Rec + TO + TRea + RebDef + RebOf + TAsist + TL_F + T3Asist, data =df_equipos)
...
df_combinaciones <- df_combinaciones[, -15]
...
df_quintetos$Media <- df_combinaciones$Diferencia
head(df_quintetos)
```
